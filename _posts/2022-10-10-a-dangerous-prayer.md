...
We cannot call upon or pray to Jesus asking Him to save us if we haven’t believed in Him first. We can’t believe in Him if we never heard the Gospel. We can’t hear the Gospel if we are never presented with it. Now, I do believe a prayer **can** be used as a tool to express one's faith, as seen in this verse and as you'll see in the next section. But again, it is **not** the prayer that we are to focus on which is essentially what is taught today. 

...
The picture of assurance from the analogy that I want to direct your attention to is that of the Worker. If we place ourselves in the shoes of the county, our budget never would account for the amount to cover the complete remodel of the road to address the pothole. It wasn't until the Worker came and completed the project by his own hands that we see our new position. How can we then, as the county, work by throwing money into a pothole that no longer exists? We can't, the pothole is gone! We can feel as though we didn't deserve it at times, but the fact remains: our problem has been addressed completely.
